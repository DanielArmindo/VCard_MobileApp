...
Mobile.setEncryptedText(findTestObject('android.widget.EditText - Pin'), '4nvbrPglk7k=', 0)

Mobile.tap(findTestObject('android.widget.Button - Criar'), 0)

Mobile.verifyElementExist(findTestObject('android.widget.TextView - O pin deve ter 3 dígitos'), 0)
