...
Mobile.setEncryptedText(findTestObject('android.widget.EditText - Password'), '8ylGA/40/qI=', 0)
...
Mobile.verifyElementExist(findTestObject('android.widget.TextView - A password deve ter pelo menos 8 caracteres'), 0)
